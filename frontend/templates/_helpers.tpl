...
helm.sh/chart: {{ .Values.nameOverride }}
...
*/}}
{{- define "hello-k8s.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hello-k8s.name" .) .Values.serviceAccount.name }}
{{- else }}
...
{{/*Common labels*/}}
{{- define "common.podientityLabels" -}}
